...
exports.calculateTimeToRead = void 0;
...
const calculateTimeToRead = (mdNode, html, calcTimeToRead) => {
  ...
  const timeToReadInMinutes = Math.max(1, Math.round(_.isFunction(calcTimeToRead) ? calcTimeToRead(wordCount, pureText, mdNode.rawMarkdownBody) : wordCount / avgWPM));
  return timeToReadInMinutes;
};

exports.calculateTimeToRead = calculateTimeToRead;