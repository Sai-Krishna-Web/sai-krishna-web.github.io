...
透過這個 Starter，你可以快速建立一個如同 [Calpa's Blog](https://heisenberg-blog.netlify.app) 的博客系統。
...
如果你喜歡 [我的博客](https://heisenberg-blog.netlify.app)，請給個 star，多謝。
...
[Calpa 的博客](https://heisenberg-blog.netlify.app/) 目前正在使用[Netlify](https://www.netlify.com/)，當然，您可以使用 Github Pages 作為替代方案。
